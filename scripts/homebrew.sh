...
brew install zoxide starship bat lazygit lsd fzf ripgrep btop fd duf gdu atuin procs tlrc yazi helix 7zip jq go || error "Échec de l'installation des outils"
